                        ...
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="medilife-contact-info mr-5">
                                    ...
                                    <!-- Single Contact Info -->
                                    <div class="single-contact-info mb-30">
                                        <img src="<?=base_url()?>assets/img/icons/envelope.png" alt="">
                                        <p>0080 673 729 766 <br>contact@business.com</p>
                                    </div>
                                    <!-- Single Contact Info -->
                                    <div class="single-contact-info">
                                        <img src="<?=base_url()?>assets/img/icons/map-pin.png" alt="">
    ...
    <!-- ***** About Us Area End ***** -->
        ...
        <div class="single-gallery-item">
            ...
            <div class="view-more-btn">
                <a href="<?=base_url()?>assets/img/bg-img/g1.jpg" class="btn gallery-img">See More +</a>
            </div>
        </div>
        <!-- Single Gallery Item -->
        <div class="single-gallery-item">
            <img src="<?=base_url()?>assets/img/bg-img/g2.jpg" alt="">
            <div class="view-more-btn">
                <a href="<?=base_url()?>assets/img/bg-img/g2.jpg" class="btn gallery-img">See More +</a>
            </div>
        </div>
        <!-- Single Gallery Item -->
        <div class="single-gallery-item">
            <img src="<?=base_url()?>assets/img/bg-img/g3.jpg" alt="">
            <div class="view-more-btn">
                <a href="<?=base_url()?>assets/img/bg-img/g3.jpg" class="btn gallery-img">See More +</a>
            </div>
        </div>

        <!-- Single Gallery Item -->
        <div class="single-gallery-item">
            <img src="<?=base_url()?>assets/img/bg-img/g4.jpg" alt="">
            <div class="view-more-btn">
                <a href="<?=base_url()?>assets/img/bg-img/g4.jpg" class="btn gallery-img">See More +</a>
            </div>
        </div>
    </div>
    <!-- ***** Gallery Area End ***** -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="features-thumbnail">
                        <img src="<?=base_url()?>assets/img/bg-img/medical1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
