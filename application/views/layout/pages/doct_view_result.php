    ...
    <section class="medilife-contact-area section-padding-100" >
        ...
        <!-- <a href="<?//=site_url('home/search')?>" class="medilife-appoint btn-dark pt-2 pb-2 pl-4 pr-4" style="position:relative;left:85%;"><i class="fa fa-eye"></i> Search Record </a> -->
            <div class="row">
                <!-- Contact Form Area -->
                <?php if($result) { ?>
                    <h4> Make Correction on Prescription </h4>
                        ...
                        <?php $counter=1; foreach($result as $row){ ?>
                            ...
                            <td style="float:right;"> 
                             ...
                             <?php }else{?>
                              ...
                              <?php }?>
                              <a href="<?=base_url('home/edit_patient_rec/'.$row->id)?>"   class="appoint bg-warning pl-2 pr-2 text-white pt-2 pb-2 text-end text-dark"><i class="fa fa-pencil"></i> Edit  </a>
            ...
            <a href="<?=site_url('home/doct_board')?>" class="medilife-appoint btn-dark pt-2 pb-2 pl-4 pr-4"><i class="fa fa-backward"></i> Prev </a>
        </div>
    </section>
